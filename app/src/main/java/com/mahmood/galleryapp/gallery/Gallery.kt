package com.mahmood.galleryapp.gallery
...
import com.mahmood.galleryapp.sealed.DataStates
...
fun ShowImageList(image: MutableList<String>) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Text(text = "Horizontal Row", fontSize = 14.sp,
        ...
        Text(text = "Grids", fontSize = 14.sp,
            modifier = Modifier.padding(10.dp,0.dp,0.dp,0.dp))
